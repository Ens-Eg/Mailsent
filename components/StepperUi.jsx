...
export default function Stepper({
  ...
  return (
    <div
      className="flex  flex-1 flex-col items-center justify-center  mb-15"
      {...rest}
    >
      <div
        className={`mx-auto w-full max-w-[600px] rounded-4xl shadow-xl ${stepCircleContainerClassName} ]`}
          ...
          <div className={`px-8 pb-8 ${footerClassName}`}>
            ...
            >
              ...
              <button
                ...
                {...nextButtonProps}
              >
                {isLastStep ? "ارسال البيانات" : nextButtonText}
              </button>
            </div>
          </div>
        )}
